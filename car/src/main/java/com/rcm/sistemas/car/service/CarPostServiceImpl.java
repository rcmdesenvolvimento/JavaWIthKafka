...
import com.rcm.sistemas.car.repository.CarPostRepository;
...
public class CarPostServiceImpl implements CarPostService {
	...
	private CarPostEntity mapCarDtoToEntity(CarPostDTO carPostDTO) {
		...
		ownerPostRepository.findById(
				carPostDTO.getOwnerId()).ifPresentOrElse(item -> {
	...
	private CarPostDTO mapCarEntityToDTO(CarPostEntity carPostEntity) {
		...
		return CarPostDTO.builder().brand(carPostEntity.getBrand())
